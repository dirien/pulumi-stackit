...
class RoutingTableRouteArgs:
    def __init__(__self__, *,
                 ...
                 routing_table_id: pulumi.Input[builtins.str],
    ...
    def routing_table_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def routing_table_id(self, value: pulumi.Input[builtins.str]):
...
class _RoutingTableRouteState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] created_at: Date-time when the route was created.
        :param pulumi.Input['RoutingTableRouteDestinationArgs'] destination: Destination of the route.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] labels: Labels are key-value string pairs which can be attached to a resource container
        :param pulumi.Input[builtins.str] network_area_id: The network area ID to which the routing table is associated.
        :param pulumi.Input['RoutingTableRouteNextHopArgs'] next_hop: Next hop destination.
        :param pulumi.Input[builtins.str] organization_id: STACKIT organization ID to which the routing table is associated.
        :param pulumi.Input[builtins.str] region: The resource region. If not defined, the provider region is used.
        :param pulumi.Input[builtins.str] route_id: The ID of the route.
        :param pulumi.Input[builtins.str] routing_table_id: The routing tables ID.
        :param pulumi.Input[builtins.str] updated_at: Date-time when the route was updated.
        """
...
class RoutingTableRoute(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            route_id: Optional[pulumi.Input[builtins.str]] = None,
            routing_table_id: Optional[pulumi.Input[builtins.str]] = None,
            updated_at: Optional[pulumi.Input[builtins.str]] = None) -> 'RoutingTableRoute':
        """
