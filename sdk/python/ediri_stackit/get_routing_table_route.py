...
def get_routing_table_route(network_area_id: Optional[builtins.str] = None,
...
def get_routing_table_route_output(network_area_id: Optional[pulumi.Input[builtins.str]] = None,
