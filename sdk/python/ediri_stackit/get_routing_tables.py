...
def get_routing_tables(network_area_id: Optional[builtins.str] = None,
...
def get_routing_tables_output(network_area_id: Optional[pulumi.Input[builtins.str]] = None,
