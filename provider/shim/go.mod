...
require (
	...
	github.com/stackitcloud/terraform-provider-stackit v0.60.0
)

require github.com/stackitcloud/stackit-sdk-go/services/iaasalpha v0.1.21-alpha // indirect
...
require (
	...
	github.com/stackitcloud/stackit-sdk-go/services/iaas v0.29.0 // indirect
