...
require (
	...
	github.com/stackitcloud/terraform-provider-stackit v0.78.0
)

require github.com/stackitcloud/stackit-sdk-go/services/iaasalpha v0.1.23-alpha // indirect
...
require (
	...
	github.com/stackitcloud/stackit-sdk-go/services/edge v0.3.0 // indirect
